...
@elseif(auth()->user()->photo)
    ...
    <img src="{{ auth()->user()->cloudinary_url }}"
@elseif(auth()->user()->photo)
    <img @if(auth()->user()->has_cloudinary && auth()->user()->cloudinary_url)
    <img src="{{ auth()->user()->cloudinary_url }}"
@elseif(auth()->user()->photo)
@if(auth()->user()->has_cloudinary && auth()->user()->cloudinary_url)
    <img src="{{ auth()->user()->cloudinary_url }}" src="{{ asset('storage/' . auth()->
@elseif(auth()->user()->photo)
    <img src="{{ asset('storage/' . auth()->user()->photo) }}" src="{{ asset('storage/' . auth()->
@else
