...
@elseif($media->chemin)
@if($media->has_cloudinary && $media->cloudinary_url)
    <img src="{{ $media->cloudinary_url }}" alt="{{ $media->description ?? 'Image' }}" src="{{ asset('storage/' . $media->
@elseif($media->chemin)
    <img src="{{ asset('storage/' . $media->chemin) }}" alt="{{ $media->description ?? 'Image' }}" src="{{ asset('storage/' . $media->
@endif
@endif
@endif
@endif
...
@if($contenu->auteur->has_cloudinary && $contenu->auteur->cloudinary_url)
    <img src="{{ $contenu->auteur->cloudinary_url }}"
@elseif($contenu->auteur->photo)
    @if($contenu->auteur->has_cloudinary && $contenu->auteur->cloudinary_url)
    <img src="{{ $contenu->auteur->cloudinary_url }}"
@elseif($contenu->auteur->photo)
    @if($contenu->auteur->has_cloudinary && $contenu->auteur->cloudinary_url)
...
@elseif($contenu->auteur->photo)
@if($contenu->auteur->has_cloudinary && $contenu->auteur->cloudinary_url)
    <img src="{{ $contenu->auteur->cloudinary_url }}" src="{{ asset('storage/' . $contenu->
@elseif($contenu->auteur->photo)
    <img src="{{ asset('storage/' . $contenu->auteur->photo) }}" src="{{ asset('storage/' . $contenu->
@else
    <div class="avatar-default">{{ substr($contenu->auteur->name, 0, 1) }}</div>
@endif
@else
    <div class="avatar-default">{{ substr($contenu->auteur->name, 0, 1) }}</div>
@endif{{ substr($contenu->auteur->name, 0, 1) }}</div>
@endif
@else
    <div class="avatar-default">{{ substr($contenu->auteur->name, 0, 1) }}</div>
@endif
