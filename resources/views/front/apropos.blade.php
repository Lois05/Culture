        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}">
                <div class="holographic-card">
                    <div class="card-icon-3d" style="background: {{ $value['color'] }}; color: white;">
                        <i class="bi {{ $value['icon'] }}"></i>
                    </div>
                    <h3 class="fw-bold mb-3 text-center">{{ $value['title'] }}</h3>
                    <p class="text-muted mb-0 text-center">{{ $value['description'] }}</p>
                </div>
            </div>
            @endforeach
        </div>
...
<section class="py-6 bg-dark">
    <div class="container">
        ...
        <div class="interactive-timeline">
            ...
            <div class="timeline-node" data-aos="fade-{{ $index % 2 == 0 ? 'left' : 'right' }}" data-aos-delay="{{ $index * 100 }}">
                <div class="timeline-dot" onclick="showTimelineDetails({{ $index }})"></div>
                <div class="holographic-card">
                    <div class="d-flex align-items-center mb-4">
                        <div class="rounded-circle p-3 me-3" style="background: var(--gradient-benin);">
                            <i class="bi {{ $milestone['icon'] }} text-white fs-4"></i>
                        </div>
                        <div>
                            <h4 class="fw-bold mb-1">{{ $milestone['title'] }}</h4>
                            <span class="text-primary">{{ $milestone['date'] }}</span>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="partners-container" data-aos="fade-up">
            ...
            <div class="partner-particle" style="
                ...
                z-index: {{ $index }};
            ">
                <i class="bi {{ $partner['icon'] }} fs-1" style="color: {{
                    $index == 0 ? '#E8112D' :
                    ($index == 1 ? '#FCD116' :
                    ($index == 2 ? '#008751' :
                    ($index == 3 ? '#0D6EFD' :
                ...
                <div class="cta-portal" data-aos="zoom-in" data-aos-duration="2000">
                    <div class="portal-content">
                        ...
                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <a href="{{ route('front.inscription') }}" class="btn btn-light rounded-pill px-4">
                                <i class="bi bi-person-plus me-2"></i>S'inscrire
                            </a>
                            <a href="{{ route('dashboard.contribuer') }}" class="btn btn-outline-light rounded-pill px-4">
