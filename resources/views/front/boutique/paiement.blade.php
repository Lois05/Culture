                ...
                <div class="payment-card">
                    ...
                    <div class="p-4 p-md-5">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <form id="payment-form" action="{{ route('boutique.process.paiement') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="payment-summary">
                                            ...
                                            <div class="summary-item">
                                                <span>Durée :</span>
                                                <span>
                                                    {{ $achat['period'] == 'monthly' ? '1 mois' : '' }}
                                                    {{ $achat['period'] == 'yearly' ? '1 an' : '' }}
                                                    {{ $achat['period'] == 'lifetime' ? 'À vie' : '' }}
                                                </span>
                                            </div>
                                            <div class="summary-item">
                                                <span>Prix :</span>
                                                <span class="fw-bold">{{ number_format($achat['prix'], 0, ',', ' ') }} FCFA</span>
                                            </div>
                                            @if($achat['period'] == 'yearly' || $achat['period'] == 'lifetime')
                                            <div class="summary-item text-success">
                                                <span>Économie :</span>
                                                <span class="fw-bold">
                                                    {{ number_format($achat['prix_mensuel'] * 12 - $achat['prix'], 0, ',', ' ') }} FCFA
                                                </span>
                                            </div>
                                            @endif
                                            <div class="summary-item total">
                                                <span>Total à payer :</span>
                                                <span class="text-primary">{{ number_format($achat['prix'], 0, ',', ' ') }} FCFA</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid gap-3">
                                        <button type="submit" class="btn btn-primary btn-lg py-3 fw-bold" id="submit-btn">
                                            ...
                                            Payer maintenant
                                            <span id="amount-display">{{ number_format($achat['prix'], 0, ',', ' ') }} FCFA</span>
                                        </button>

                                        <a href="{{ route('boutique.annuler') }}" class="btn btn-outline-dark btn-lg py-3">
