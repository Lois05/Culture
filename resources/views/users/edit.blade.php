...
<main class="app-main min-vh-100">
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.users.show', $user->id) }}" class="btn btn-outline-secondary btn-lg">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="email_verified">
                                                @if($user->email_verified_at)
                                                    <span class="text-success">Vérifié le {{ $user->email_verified_at->format('d/m/Y') }}</span>
                                                @else
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <div class="text-center">
                                            <div class="position-relative d-inline-block">
                                                ...
                                                <div class="current-photo rounded-circle border shadow d-flex align-items-center justify-content-center {{ ($user->photo && ($photoExists ?? false)) ? 'd-none' : '' }}"
                ...
                <div class="card shadow-sm border-0 rounded-3 mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <h5 id="previewName" class="mt-3 mb-1">{{ $user->name }} {{ $user->prenom }}</h5>
                            <div id="previewEmail" class="text-muted">{{ $user->email }}</div>
                        </div>
                        ...
                        <div class="preview-info">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>Statut :</span>
                                <span id="previewStatut" class="badge {{ $user->statut == 'actif' ? 'bg-success' : 'bg-danger' }}">
                                    {{ ucfirst($user->statut) }}
                                </span>
                            </div>
