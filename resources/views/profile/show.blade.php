                            ...
                            <div class="col-md-4 text-center mb-4">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="profile-photo rounded-circle border-4 border-primary shadow-lg d-flex align-items-center justify-content-center
                                        ...
                                        <span class="text-white fw-bold display-4">{{ $initial }}</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                            ...
                                            <div>
                                                <h5 class="mb-0 fw-bold">{{ $user->name }} {{ $user->prenom }}</h5>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="p-3 border rounded-3">
                    <h3 class="text-primary mb-1">
                        {{ isset($user->contenus) ? $user->contenus->count() : 0 }}
                    </h3>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="p-3 border rounded-3">
                    <h3 class="text-success mb-1">
                        {{ isset($user->commentaires) ? $user->commentaires->count() : 0 }}
                    </h3>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="p-3 border rounded-3">
                    <h3 class="text-warning mb-1">
                        {{ isset($user->medias) ? $user->medias->count() : 0 }}
                    </h3>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="p-3 border rounded-3">
                    @if($user->last_login_at)
                        <h6 class="text-info mb-1">{{ \Carbon\Carbon::parse($user->last_login_at)->format('d/m/Y') }}</h6>
                    @else
                ...
                <div class="card shadow-lg border-0 rounded-3 mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('admin.tableaudebord') }}" class="btn btn-outline-info">
