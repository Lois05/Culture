...
@section('page-title', 'Associations Langue/Région')
...
<main class="app-main bg-light min-vh-100">
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('admin.parler.create') }}" class="btn btn-gradient btn-lg shadow">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <!-- Voir -->
                                        <a href="{{ route('admin.parler.show', $parler) }}"
                                        ...
                                        <button type="button"
                                                ...
                                                data-id="{{ $parler->id_parler }}"
                                                data-name="{{ $parler->region->nom_region ?? 'Région' }} - {{ $parler->langue->nom_langue ?? 'Langue' }}"
                                                title="Supprimer"
                                                data-bs-toggle="tooltip">
