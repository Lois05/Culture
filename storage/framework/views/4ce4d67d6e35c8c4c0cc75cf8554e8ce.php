<?php $__env->startSection('title', 'Paiement échoué - Bénin Culture'); ?>
            ...
            <div class="col-lg-8">
                <div class="failure-card">
                    ...
                    <div class="error-details">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="fw-bold"><?php echo e($reference ?? 'N/A'); ?></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <small class="text-muted">Date</small>
                                <div class="fw-bold"><?php echo e(now()->format('d/m/Y H:i')); ?></div>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="d-grid gap-3 d-md-flex justify-content-center mb-4">
                        <a href="<?php echo e(route('boutique.paiement')); ?>" class="btn btn-danger btn-lg px-5">
                            <i class="bi bi-arrow-clockwise me-2"></i>
                            Réessayer le paiement
                        </a>

                        <a href="<?php echo e(route('boutique.choisir')); ?>" class="btn btn-outline-dark btn-lg px-5">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        window.location.href = "<?php echo e(route('boutique.paiement')); ?>";
    }, 30000);
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\boutique\echec.blade.php ENDPATH**/ ?>