            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(route('langues.index')); ?>" class="btn btn-sm btn-secondary float-end">Retour</a>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('langues.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\langues\create.blade.php ENDPATH**/ ?>