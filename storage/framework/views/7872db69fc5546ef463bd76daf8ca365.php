<?php $__env->startSection('title', 'Régions du Bénin - Bénin Culture'); ?>
...
<style>
    ...
    .card-header-premium::before {
        ...
        right: 0;
        bottom: 0;
background: url('<?php echo e(asset('adminlte/img/pattern.png')); ?>');
        opacity: 0.1;
    }
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <p class="lead text-white mb-5 fs-4" data-aos="fade-up" data-aos-delay="200">
                    Découvrez la diversité culturelle à travers <?php echo e($stats['total_regions'] ?? 12); ?> régions uniques
                </p>
                ...
                <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="400">
                    <div class="col-md-3 col-6 mb-4">
                        <div class="stat-card-modern text-center">
                            <div class="stat-number-modern" id="regionsCount"><?php echo e($stats['total_regions'] ?? 12); ?></div>
                    ...
                    <div class="col-md-3 col-6 mb-4">
                        <div class="stat-card-modern text-center">
                            <div class="stat-number-modern" id="contributorsCount"><?php echo e($stats['total_utilisateurs'] ?? 150); ?></div>
                            <div class="stat-label-premium">Contributeurs</div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 mb-4">
                        <div class="stat-card-modern text-center">
                            <div class="stat-number-modern" id="contentsCount"><?php echo e($stats['total_contenus'] ?? 1000); ?></div>
...
<section class="regions-section">
    <div class="container">
        ...
        <div class="filters-modern" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="stats-cards">
                <div class="stat-card-modern">
                    <div class="stat-number-modern"><?php echo e($stats['total_regions'] ?? 12); ?></div>
                ...
                <div class="stat-card-modern">
                    <div class="stat-number-modern"><?php echo e($stats['total_contenus'] ?? 1000); ?></div>
                    <div class="stat-label-premium">Histoires</div>
                    <small class="text-muted">Contenus culturels</small>
                </div>
                <div class="stat-card-modern">
                    <div class="stat-number-modern"><?php echo e($stats['total_utilisateurs'] ?? 150); ?>+</div>
        ...
        <!-- Grid des régions -->
        <?php if($regions && $regions->count() > 0): ?>
    ...
    $regionColorDark = $colorPair['dark'];
                    ...
                    <div class="region-card-premium"
                         ...
                         data-region-name="<?php echo e(strtolower($region->nom_region)); ?>"
                         data-region-zone="<?php echo e($loop->index <= 6 ? 'nord' : 'sud'); ?>">
                        <!-- En-tête de la carte -->
                        <div class="card-header-premium"style="background: linear-gradient(135deg, <?php echo e($regionColor); ?>, <?php echo e($regionColorDark); ?>);">
                        ...
                        <div class="card-body-premium">
                            ...
                            <?php if($region->description): ?>
                                <p class="region-description">
                                    <?php echo e(Str::limit($region->description, 120)); ?>
                            ...
                            <div class="region-stats">
                                <div class="stat-item-premium">
                                    <div class="stat-number-premium"><?php echo e($region->contenus_count ?? 0); ?></div>
                                    <div class="stat-label-premium">Contenus</div>
                                </div>
                                <div class="stat-item-premium">
                                    <div class="stat-number-premium"><?php echo e($contributeurs); ?></div>
                                    <div class="stat-label-premium">Contributeurs</div>
                                </div>
                                <div class="stat-item-premium">
                                    <div class="stat-number-premium"><?php echo e(count($langues)); ?></div>
                            ...
                            <div class="region-languages">
                                <?php $__currentLoopData = array_slice($langues, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="language-tag">
                                        <i class="fas fa-comment-dots me-1"></i><?php echo e($langue); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($langues) > 3): ?>
                                    <span class="language-tag">
                                        +<?php echo e(count($langues) - 3); ?>
                            ...
                            <a href="<?php echo e(route('front.region', ['slug' => $slug])); ?>"
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="<?php echo e(route('dashboard.contribuer')); ?>" class="btn btn-light btn-lg px-5">
...
<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views/front/regions.blade.php ENDPATH**/ ?>