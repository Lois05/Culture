<?php $__env->startSection('title', 'Contribuer - Documenter la culture du Bénin'); ?>
...
<main class="contribute-page">
        ...
        <div class="container hero-inner">
            <div class="hero-left">
                ...
                <div class="hero-stats">
                    <div class="stat">
                        <div class="stat-number" data-target="<?php echo e($stats['total_contents'] ?? 150); ?>">0</div>
                        <div class="stat-label">Contenus publiés</div>
                    </div>
                    <div class="stat">
                        <div class="stat-number" data-target="<?php echo e($stats['total_contributors'] ?? 45); ?>">0</div>
    ...
    <section id="formSection" class="contribution-form">
        <div class="container">
            <form id="contributionForm" action="<?php echo e(route('contribute.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                ...
                                <select id="id_region" name="id_region" class="modern-select" required>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Region::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($r->id_region); ?>"><?php echo e($r->nom_region); ?></option>
                            ...
                            <div class="field">
                                ...
                                <select id="id_type_contenu" name="id_type_contenu" class="modern-select">
                                    ...
                                    <?php $__currentLoopData = \App\Models\TypeContenu::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($t->id_type_contenu); ?>"><?php echo e($t->nom_contenu); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <select id="id_langue" name="id_langue" class="modern-select">
                                    ...
                                    <?php $__currentLoopData = \App\Models\Langue::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($l->id_langue); ?>"><?php echo e($l->nom_langue); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\contribute.blade.php ENDPATH**/ ?>