    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <!-- Body -->
                <div class="card-body">
                    <form action="<?php echo e(route('typecontenus.update', $typecontenu->id_type_contenu)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nom_contenu" id="nom_contenu"
                                   value="<?php echo e(old('nom_contenu', $typecontenu->nom_contenu)); ?>"
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\typecontenus\edit.blade.php ENDPATH**/ ?>