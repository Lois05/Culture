<?php $__env->startSection('page-title', 'Gestion des Médias'); ?>
            ...
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                    <h4 class="mb-0 fw-bold">
                        ...
                        <span class="badge bg-light text-primary ms-2"><?php echo e($medias->count()); ?></span>
                    </h4>
                    <div>
                        <a href="<?php echo e(route('admin.medias.create')); ?>" class="btn btn-light btn-lg">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3 col-6 mb-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body text-center">
                                    <h2 class="mb-0"><?php echo e($medias->count()); ?></h2>
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    <h2 class="mb-0"><?php echo e($medias->where('id_type_media', 1)->count()); ?></h2>
                                    <small>Images</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <div class="card bg-danger text-white">
                                <div class="card-body text-center">
                                    <h2 class="mb-0"><?php echo e($medias->where('id_type_media', 2)->count()); ?></h2>
                                    <small>Vidéos</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <div class="card bg-warning text-dark">
                                <div class="card-body text-center">
                                    <h2 class="mb-0"><?php echo e($medias->where('id_type_media', 3)->count()); ?></h2>
                                    <small>Audios</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="filterContenu">
                                        ...
                                        <?php if(isset($contenus) && $contenus->count() > 0): ?>
                                            <?php $__currentLoopData = $contenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($contenu->id_contenu); ?>"><?php echo e($contenu->titre); ?></option>
                            ...
                            <table id="mediasTable" class="table table-hover align-middle w-100" style="font-size: 0.9rem;">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr data-type="<?php echo e($media->id_type_media); ?>"
                                            data-contenu="<?php echo e($media->id_contenu); ?>"
                                            data-status="<?php echo e($fileStatus); ?>">
                                            <td>
                                                <span class="badge bg-secondary">#<?php echo e($media->id_media); ?></span>
                                            </td>
                                            <td>
                                                <div class="media-thumbnail
                                                    <?php if($media->id_type_media == 1): ?> image-thumbnail
                                                    <?php elseif($media->id_type_media == 2): ?> video-thumbnail
                                                    <?php else: ?> audio-thumbnail
                                                    <?php endif; ?>"
                                                    onclick="previewMedia(<?php echo e($media->id_media); ?>, '<?php echo e(addslashes($media->chemin)); ?>', <?php echo e($media->id_type_media); ?>, '<?php echo e($fileUrl); ?>')"
                                                    ...
                                                    <?php if($media->id_type_media == 1): ?>
                                                        ...
                                                        <?php if($isExternalUrl): ?>
                                                            ...
                                                            <img src="<?php echo e($fileUrl); ?>"
                                                                 ...
                                                                 onerror="this.onerror=null; this.src='<?php echo e(asset('adminlte/img/default-content.jpg')); ?>'; this.nextElementSibling.style.display='flex';"
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($typeBadge); ?> badge-sm">
                                                    <i class="bi <?php echo e($typeIcon); ?> me-1"></i> <?php echo e($typeText); ?>
                                            ...
                                            <td>
                                                <div class="small">
                                                    <?php if($media->description): ?>
                                                        <?php echo e(Str::limit($media->description, 50)); ?>
                                                ...
                                                <?php if($media->contenu): ?>
                                                    <a href="<?php echo e(route('admin.contenus.show', $media->contenu->id_contenu)); ?>"
                                                       class="d-block text-decoration-none">
                                                        <div class="fw-medium"><?php echo e(Str::limit($media->contenu->titre, 20)); ?></div>
                                            ...
                                            <td>
                                                <div class="small text-muted">
                                                    <div><?php echo e($media->created_at->format('d/m/Y')); ?></div>
                                                    <div><?php echo e($media->created_at->format('H:i')); ?></div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-id="<?php echo e($media->id_media); ?>"
                                                            data-name="<?php echo e(basename($media->chemin)); ?>"
                                                            title="Supprimer"
                                                            data-bs-toggle="tooltip"
                                                            data-bs-target="#deleteModal<?php echo e($media->id_media); ?>">
                                        ...
                                        <div class="modal fade" id="deleteModal<?php echo e($media->id_media); ?>" tabindex="-1">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?php echo e(route('admin.medias.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\medias\index.blade.php ENDPATH**/ ?>