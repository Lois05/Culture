<?php $__env->startSection('title', 'Paramètres du compte'); ?>
<?php $__env->startSection('page-title', 'Paramètres du compte'); ?>
...
<div class="row fade-in">
    ...
    <div class="col-lg-8">
        <div class="dashboard-card mb-4">
            ...
            <form method="POST" action="<?php echo e(route('dashboard.settings.profile.update')); ?>" enctype="multipart/form-data" id="profileForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="rounded-circle mb-3 d-flex align-items-center justify-content-center <?php echo e($hasPhoto && $photoUrl ? 'd-none' : 'd-flex'); ?>"
...
unset($__errorArgs, $__bag); ?>" id="sexe" name="sexe" required>
                                    <option value="">Sélectionnez...</option>
                                    <option value="M" <?php echo e(old('sexe', $user->sexe ?? '') == 'M' ? 'selected' : ''); ?>>Masculin</option>
                                    <option value="F" <?php echo e(old('sexe', $user->sexe ?? '') == 'F' ? 'selected' : ''); ?>>Féminin</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                       id="date_naissance"
                                       name="date_naissance"
                                      value="<?php echo e(old('date_naissance', $user->date_naissance ? (\Carbon\Carbon::parse($user->date_naissance)->format('Y-m-d')) : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select <?php $__errorArgs = ['id_langue'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="id_langue" name="id_langue">
                                    ...
                                    <?php $__currentLoopData = $langues ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($langue->id_langue ?? ''); ?>"
                                                <?php echo e(old('id_langue', $user->id_langue ?? '') == ($langue->id_langue ?? '') ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="dashboard-card mb-4">
            ...
            <form method="POST" action="<?php echo e(route('dashboard.settings.password.update')); ?>" id="passwordForm">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="<?php echo e(route('dashboard.settings.delete')); ?>" id="deleteForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\dashboard\settings.blade.php ENDPATH**/ ?>