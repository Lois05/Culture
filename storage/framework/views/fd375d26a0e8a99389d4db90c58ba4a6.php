...
<head>
    ...
    <title>Bénin Culture | <?php echo $__env->yieldContent('title', 'Accueil'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('front.home') ? 'active' : ''); ?>"
                           href="<?php echo e(route('front.home')); ?>">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('front.explorer') ? 'active' : ''); ?>"
                           href="<?php echo e(route('front.explorer')); ?>">Explorer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('front.regions') ? 'active' : ''); ?>"
                           href="<?php echo e(route('front.regions')); ?>">Régions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('front.apropos') ? 'active' : ''); ?>"
                           href="<?php echo e(route('front.apropos')); ?>">À propos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('boutique.index') ? 'active' : ''); ?>"
                           href="<?php echo e(route('boutique.index')); ?>">
...
?>
                               ...
                               data-bs-toggle="dropdown" aria-expanded="false">
                                <?php if($showImage): ?>
                                    <img src="<?php echo e($photoUrl); ?>"
                                         alt="<?php echo e($avatarInfo['name']); ?>"
                                ...
                                <div class="rounded-circle d-flex align-items-center justify-content-center me-2"
                                     style="width: 40px; height: 40px; background: <?php echo e($avatarInfo['color']); ?>; color: white; font-weight: bold; <?php echo e($showImage ? 'display: none;' : 'display: flex;'); ?>"
                                     id="nav-profile-initials">
                                    <?php echo e($userInitial); ?>

                                </div>

                                <span class="d-none d-lg-inline ms-1"><?php echo e($avatarInfo['name']); ?></span>
                            </a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li>
                                    <h6 class="dropdown-header">
                                        ...
                                        <strong><?php echo e($avatarInfo['name']); ?></strong>
                                        <small class="d-block"><?php echo e($user->email); ?></small>
                                    </h6>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <!-- CORRECTION ICI : Utilisation de $dashboardRoute pour la redirection -->
                                    <a class="dropdown-item" href="<?php echo e(route($dashboardRoute)); ?>">
                                ...
                                <?php if($isAdmin || $isModerator): ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.contenus.index')); ?>">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <form method="POST" action="<?php echo e(route('deconnexion')); ?>" id="logout-form">
                                        <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('front.inscription')); ?>" class="btn btn-primary">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('front.explorer')); ?>" class="text-white-50 text-decoration-none">Contenus</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('front.regions')); ?>" class="text-white-50 text-decoration-none">Régions</a></li>
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('dashboard.contribuer')); ?>" class="text-white-50 text-decoration-none">Ajouter un contenu</a></li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0 text-white-50">
                        &copy; <?php echo e(date('Y')); ?> Bénin Culture. Tous droits réservés.
                    </p>
                </div>
            ...
            function showResults() {
                ...
                document.getElementById('quiz-options').innerHTML = `
                    <div class="text-center mt-4">
                        ...
                        <a href="<?php echo e(route('front.explorer')); ?>" class="btn btn-outline-light mb-2">
...
<?php /**PATH C:\wamp64\www\culture\resources\views/layouts/layout_front.blade.php ENDPATH**/ ?>