...
<main class="app-main">
    <div class="container mt-4">
        <div class="card shadow-lg border-0">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.medias.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_type_media" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->id_type_media); ?>"><?php echo e($type->nom_type_media); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\medias\create.blade.php ENDPATH**/ ?>