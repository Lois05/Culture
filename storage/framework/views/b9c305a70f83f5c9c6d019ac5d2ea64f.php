...
<div class="row g-4">
    ...
    <div class="col-lg-3 col-md-6">
        <?php if(isset($card['route']) && Route::has($card['route'])): ?>
            <a href="<?php echo e(route($card['route'])); ?>" class="text-decoration-none">
        <?php endif; ?>

        <div class="card card-hover h-100 border-0 rounded-4 text-white bg-<?php echo e($card['color']); ?> position-relative">
            <?php if(isset($card['badge'])): ?>
                <div class="position-absolute top-0 end-0 p-2">
                    <span class="badge <?php echo e($card['badge']); ?> animate__animated animate__pulse animate__infinite">
                        <?php echo e($card['total']); ?> en attente
                    </span>
                </div>
            <?php endif; ?>
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="display-6 fw-bold mb-1"><?php echo e($card['total']); ?></h2>
                    <p class="mb-0 text-light small"><?php echo e($card['title']); ?></p>
                </div>
                <i class="bi <?php echo e($card['icon']); ?> fs-1 opacity-50"></i>
            </div>
        </div>
...
<?php if($contenusEnAttenteCount > 0): ?>
<div class="row mt-4">
    <div class="col-12">
        <div class="alert alert-warning alert-dismissible fade show shadow-sm" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <strong><?php echo e($contenusEnAttenteCount); ?> contenu(s) en attente de modération</strong>
                    <p class="mb-0">Des utilisateurs ont soumis des contenus qui nécessitent votre validation.</p>
                </div>
                <div class="ms-auto">
                    <a href="<?php echo e(route('admin.moderateur.index')); ?>" class="btn btn-warning btn-sm">
...
<?php if($roleName === 'Administrateur'): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <?php $__currentLoopData = $statistiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statut => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div>
                                    <div class="d-flex justify-content-between mb-1">
                                        <span>
                                            <i class="bi <?php echo e($data['icon']); ?> text-<?php echo e($data['color']); ?> me-2"></i>
                                            <?php echo e(ucfirst($statutLabel)); ?>

                                            <span class="badge bg-<?php echo e($data['color']); ?>"><?php echo e($data['count']); ?></span>
                                        </span>
                                        <span class="fw-semibold"><?php echo e($pourcentage); ?>%</span>
                                    </div>
                                    <div class="progress" style="height: 12px;">
                                        <div class="progress-bar bg-<?php echo e($data['color']); ?>"
                                             role="progressbar"
                                             style="width: <?php echo e($pourcentage); ?>%"
                                             aria-valuenow="<?php echo e($pourcentage); ?>"
                                             aria-valuemin="0"
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <?php $__currentLoopData = $rolesStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
...
<div class="row mt-5 g-4">
    ...
    <div class="col-lg-6">
        <div class="card shadow h-100 border-0 rounded-4">
            ...
            <div class="card-body p-0">
                <?php if($dernierContenus && $dernierContenus->count()): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $dernierContenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.contenus.show', $contenu->id_contenu)); ?>"
                               class="list-group-item list-group-item-action d-flex justify-content-between align-items-center border-0">
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <?php if($contenu->medias && $contenu->medias->first()): ?>
                                    ...
                                    <div>
                                        <h6 class="mb-0 fw-semibold"><?php echo e(Str::limit($contenu->titre, 40)); ?></h6>
                                        <small class="text-muted">
                                            Par <?php echo e($contenu->auteur->prenom ?? 'Anonyme'); ?> •
                                            <?php echo e($contenu->date_creation->format('d/m/Y H:i')); ?>

                                        </small>
                                    </div>
                                </div>
                                <span class="badge rounded-pill
                                    <?php if($contenu->statut === 'validé'): ?> bg-success
                                    <?php elseif($contenu->statut === 'en_attente'): ?> bg-warning
                                    <?php else: ?> bg-danger <?php endif; ?>">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $contenu->statut))); ?>
                    ...
                    <div class="card-footer bg-white border-0 text-center">
                        <a href="<?php echo e(route('admin.contenus.index')); ?>" class="btn btn-outline-primary btn-sm">
    ...
    <div class="col-lg-6">
        <div class="card shadow h-100 border-0 rounded-4">
            ...
            <div class="card-body p-0">
                <?php if($dernierUsers && $dernierUsers->count()): ?>
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $dernierUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>"
                               class="list-group-item list-group-item-action d-flex justify-content-between align-items-center border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="mb-0 fw-semibold"><?php echo e($user->prenom); ?> <?php echo e($user->name); ?></h6>
                                        <small class="text-muted"><?php echo e($user->email); ?></small>
                                    </div>
                                </div>
                                <div class="text-end">
                                    <span class="badge bg-<?php echo e($user->statut === 'actif' ? 'success' : 'danger'); ?>">
                                        <?php echo e($user->statut); ?>

                                    </span>
                                    <br>
                                    <small class="text-muted"><?php echo e($user->role->nom_role ?? 'Sans rôle'); ?></small>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php if(in_array($roleName, ['Administrateur', 'Modérateur'])): ?>
<div class="row mt-5">
    <div class="col-12">
        <div class="card shadow border-0 rounded-4">
            <div class="card-header bg-white border-0">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.contenus.create')); ?>" class="btn btn-primary w-100 h-100 py-3">
                    ...
                    <?php if($contenusEnAttenteCount > 0): ?>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.moderateur.index')); ?>" class="btn btn-warning w-100 h-100 py-3">
                            <i class="bi bi-clipboard-check fs-4 d-block mb-2"></i>
                            Modérer (<?php echo e($contenusEnAttenteCount); ?>)
                        </a>
                    </div>
                    <?php endif; ?>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-success w-100 h-100 py-3">
                            <i class="bi bi-person-plus fs-4 d-block mb-2"></i>
                            Nouvel utilisateur
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.regions.create')); ?>" class="btn btn-info w-100 h-100 py-3">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views/tableaudebord.blade.php ENDPATH**/ ?>