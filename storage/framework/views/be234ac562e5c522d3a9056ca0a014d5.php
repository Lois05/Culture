<?php $__env->startSection('page-title', 'Gestion des Langues'); ?>
...
<main class="app-main bg-light min-vh-100">
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('admin.langues.create')); ?>" class="btn btn-gradient btn-lg shadow">
            ...
            <div class="card-body">
                <table id="languesTable" class="table table-striped table-hover align-middle w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="badge bg-secondary"><?php echo e($langue->id_langue); ?></span></td>
                            <td><?php echo e($langue->nom_langue); ?></td>
                            <td><span class="badge bg-info"><?php echo e($langue->code_langue); ?></span></td>
                            <td><?php echo e(Str::limit($langue->description, 50)); ?></td>
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?php echo e(route('admin.langues.show', $langue)); ?>"
                                       class="btn btn-outline-info rounded-circle"
                                       title="Voir"
                                       data-bs-toggle="tooltip">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.langues.edit', $langue)); ?>"
                                    ...
                                    <button type="button"
                                            ...
                                            data-id="<?php echo e($langue->id_langue); ?>"
                                            data-name="<?php echo e($langue->nom_langue); ?>"
                                            title="Supprimer"
                                            data-bs-toggle="tooltip">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\langues\index.blade.php ENDPATH**/ ?>