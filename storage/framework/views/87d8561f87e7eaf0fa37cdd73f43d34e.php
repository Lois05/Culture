...
<head>
    ...
    <title>Bénin Culture | <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<body>
    ...
    <div class="dashboard-container">
        <!-- SIDEBAR -->
        <?php echo $__env->make('front.dashboard.partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <main class="dashboard-main">
            ...
            <div class="dashboard-topbar">
                <div class="topbar-left">
                    <h1><?php echo $__env->yieldContent('page-title', 'Tableau de bord'); ?></h1>
                    <p><?php echo $__env->yieldContent('page-subtitle', 'Bienvenue dans votre espace personnel'); ?></p>
                </div>
                ...
                <div class="topbar-right">
                    <div class="topbar-actions">
                        ...
                        <a href="<?php echo e(route('front.home')); ?>" class="btn btn-outline-custom">
...
<?php /**PATH C:\wamp64\www\culture\resources\views\layouts\dashboard.blade.php ENDPATH**/ ?>