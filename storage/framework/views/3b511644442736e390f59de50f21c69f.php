                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url"
                                           ...
                                           id="app_url"
                                           name="app_url"
                                           value="<?php echo e(old('app_url', $settings['app_url'])); ?>"
                                           required>
                                    <div class="form-text">
                                    ...
                                    <select class="form-select" id="app_timezone" name="app_timezone" required>
                                        <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($timezone); ?>"
                                                    <?php echo e(old('app_timezone', $settings['app_timezone']) == $timezone ? 'selected' : ''); ?>>
                                                <?php echo e($timezone); ?>
                                    ...
                                    <select class="form-select" id="app_locale" name="app_locale" required>
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($code); ?>"
                                                    <?php echo e(old('app_locale', $settings['app_locale']) == $code ? 'selected' : ''); ?>>
                                                <?php echo e($name); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="mail_mailer" name="mail_mailer" required>
                                        ...
                                        <option value="log" <?php echo e(old('mail_mailer', $settings['mail_mailer']) == 'log' ? 'selected' : ''); ?>>Log (test)</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="<?php echo e(old('session_lifetime', $settings['session_lifetime'])); ?>"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="<?php echo e(old('password_min_length', $settings['password_min_length'])); ?>"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               <?php echo e(old('password_requires_uppercase', $settings['password_requires_uppercase']) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               <?php echo e(old('password_requires_numbers', $settings['password_requires_numbers']) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               <?php echo e(old('password_requires_special', $settings['password_requires_special']) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input"
                                               ...
                                               name="enable_2fa"
                                               value="1"
                                               <?php echo e(old('enable_2fa', config('auth.2fa_enabled', true)) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               <?php echo e(old('enable_registration', config('auth.registration_enabled', true)) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input"
                                               ...
                                               name="debug_mode"
                                               value="1"
                                               <?php echo e(old('debug_mode', $settings['debug_mode']) ? 'checked' : ''); ?>>
                                ...
                                <div class="card border-warning">
                                    ...
                                    <div class="card-body">
                                        <?php if($settings['maintenance_mode']): ?>
                                            ...
                                            <a href="<?php echo e(route('admin.maintenance.disable')); ?>" class="btn btn-success">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a href="<?php echo e(route('admin.maintenance.enable')); ?>" class="btn btn-warning">
                                ...
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2">
                                            <form action="<?php echo e(route('admin.cache.clear')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-outline-info">
                                                    <i class="bi bi-arrow-clockwise me-2"></i> Vider le cache
                                                </button>
                                            </form>
                                            <form action="<?php echo e(route('admin.cache.config')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <h6><?php echo e(phpversion()); ?></h6>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <small class="text-muted">Laravel Version</small>
                                        <h6><?php echo e(app()->version()); ?></h6>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <small class="text-muted">Environment</small>
                                        <h6><?php echo e(app()->environment()); ?></h6>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <small class="text-muted">Timezone</small>
                                        <h6><?php echo e(config('app.timezone')); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#refreshConfig').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.cache.config")); ?>',
            method: 'POST',
            data: {
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\settings\index.blade.php ENDPATH**/ ?>