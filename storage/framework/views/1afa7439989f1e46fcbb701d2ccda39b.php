<?php $__env->startSection('page-title', 'Profil Utilisateur'); ?>
                ...
                <div class="col">
                    <div class="d-flex align-items-center">
                        <div class="profile-avatar-container position-relative" style="margin-top: 50px;">
                            ...
                            <!-- Fallback avatar -->
                            <div class="profile-avatar rounded-circle border-4 border-white shadow-lg d-flex align-items-center justify-content-center <?php echo e($user->photo && ($photoExists ?? false) ? 'd-none' : ''); ?>"
                                 ...
                                 <?php endswitch; ?>);">
                                <span class="text-white fw-bold display-6"><?php echo e($initial); ?></span>
                            </div>
                        ...
                        <div class="ms-4 text-white">
                            <h1 class="display-6 fw-bold mb-2"><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></h1>
        ...
        <div class="position-absolute top-0 end-0 m-4">
            <div class="btn-group shadow-sm">
                ...
                <?php if($user->statut == 'actif'): ?>
                    <form action="<?php echo e(route('admin.users.desactiver', $user->id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('admin.users.activer', $user->id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0"><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></h6>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="badge
                                        ...
                                        <?php echo e($user->role->nom_role ?? 'Non assigné'); ?>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0"><?php echo e($user->created_at->format('d/m/Y H:i')); ?></h6>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0"><?php echo e($user->updated_at->format('d/m/Y H:i')); ?></h6>
                                </div>
                            </div>
                        </div>

                        <?php if($user->adresse || $user->telephone): ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="tel:<?php echo e($user->telephone); ?>" class="text-decoration-none">
                ...
                <?php if($user->role && $user->role->permissions && $user->role->permissions->isNotEmpty()): ?>
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-white border-0 py-3">
                        <h5 class="mb-0 fw-bold text-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="d-flex align-items-center p-3 border rounded-3 bg-light">
                                    ...
                                    <div>
                                        <h6 class="mb-0"><?php echo e($permission->nom_permission ?? 'Permission'); ?></h6>
                            ...
                            <div class="position-relative d-inline-block mb-3">
                                ...
                                <svg width="120" height="120" viewBox="0 0 36 36" class="circular-chart">
                                    <path class="circle-bg"
                                          ...
                                          stroke-width="3"/>
                                    <path class="circle"
                                          stroke-dasharray="<?php echo e($statutPercentage); ?>, 100"
                                          d="M18 2.0845
                                            a 15.9155 15.9155 0 0 1 0 31.831
                                            a 15.9155 15.9155 0 0 1 0 -31.831"
                                          fill="none"
                                          stroke="<?php echo e($statutColor); ?>"
                                          stroke-width="3"
                                          stroke-linecap="round"/>
                                    <text x="18" y="20.35" class="percentage"><?php echo e($statutPercentage); ?>%</text>
                                </svg>
                            </div>
                            <h4 class="fw-bold mb-2">
                                Compte <?php echo e($user->statut == 'actif' ? 'Actif' : 'Inactif'); ?>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="mailto:<?php echo e($user->email); ?>" class="btn btn-outline-primary btn-lg">
                                <i class="bi bi-envelope me-2"></i> Envoyer un email
                            </a>

                            <!-- Vérifier si la route reset-password existe -->
                            <?php if(Route::has('admin.users.reset-password')): ?>
                            ...
                            <button class="btn btn-outline-danger btn-lg btn-delete-user"
                                    ...
                                    data-name="<?php echo e($user->name); ?> <?php echo e($user->prenom); ?>">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="text-muted small mb-0"><?php echo e($user->created_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                            <div class="timeline-item">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="text-muted small mb-0"><?php echo e($user->updated_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Voulez-vous réinitialiser le mot de passe de <strong><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></strong> ?</p>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\users\show.blade.php ENDPATH**/ ?>