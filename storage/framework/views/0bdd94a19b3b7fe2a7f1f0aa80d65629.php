<?php $__env->startSection('title', 'Connexion - Bénin Culture'); ?>
        ...
        <div class="auth-container">
            ...
            <div class="auth-glass-card">
                ...
                <div class="auth-body">
                    ...
                    <!-- Login Form -->
                    <form method="POST" action="<?php echo e(route('front.connexion.post')); ?>" id="loginForm">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="auth-footer">
                        <p class="text-muted mb-0">
                            ...
                            <a href="<?php echo e(route('front.inscription')); ?>" class="register-link ms-1">
                                Créez votre compte
                            </a>
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\connexion.blade.php ENDPATH**/ ?>