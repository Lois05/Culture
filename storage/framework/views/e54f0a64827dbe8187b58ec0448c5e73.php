...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - Culture Bénin'); ?></title>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 shadow-lg border-0" style="min-width: 320px;">
            ...
            <div class="p-2" style="max-height: 300px; overflow-y: auto;">
                <a href="#" class="dropdown-item p-3 border-bottom">
                    <div class="d-flex align-items-start">
                        <div class="position-relative me-3">
                            <img src="<?php echo e(asset('assets/img/user1-128x128.jpg')); ?>"
                ...
                <a href="#" class="dropdown-item p-3">
                    <div class="d-flex align-items-start">
                        <div class="position-relative me-3">
                            <img src="<?php echo e(asset('assets/img/user3-128x128.jpg')); ?>"
                                 class="rounded-circle"
                                 width="45" height="45"
                                 alt="User">
                        </div>
    ...
    <li class="nav-item dropdown user-menu ms-3">
        <a href="#" class="nav-link dropdown-toggle d-flex align-items-center p-0" data-bs-toggle="dropdown">
            <div class="position-relative">
                ...
                <div class="rounded-circle border border-3 border-primary d-flex align-items-center justify-content-center
                    ...
                    <span class="text-white fw-bold fs-5"><?php echo e($initial); ?></span>
                </div>

                <!-- Badge de statut -->
                <span class="position-absolute bottom-0 end-0 bg-success border border-2 border-white rounded-circle"
                      style="width: 12px; height: 12px;"
                      title="<?php echo e($user->statut == 'actif' ? 'En ligne' : 'Hors ligne'); ?>"></span>
            </div>
            <div class="d-none d-lg-block ms-2">
                <span class="fw-bold"><?php echo e($user->name); ?></span>
                <br>
                <small class="text-muted"><?php echo e($user->role->nom_role ?? 'Utilisateur'); ?></small>
            </div>
        </a>
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3" style="min-width: 280px;">
            ...
            <li class="dropdown-header bg-gradient-primary text-white p-4 rounded-top">
                ...
                <h6 class="mb-1 fw-bold text-center"><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></h6>
                <p class="mb-0 text-center small opacity-75"><?php echo e($user->email); ?></p>
                <div class="text-center mt-2">
                    <span class="badge <?php echo e($user->statut == 'actif' ? 'bg-success' : 'bg-danger'); ?>">
                        <i class="bi bi-circle-fill me-1"></i> <?php echo e(ucfirst($user->statut)); ?>

                    </span>
                    <span class="badge bg-info ms-1"><?php echo e($user->role->nom_role ?? 'Utilisateur'); ?></span>
                </div>
            </li>
            ...
            <!-- Liens rapides -->
            <li>
                <a href="<?php echo e(route('admin.profile.show', $user->id)); ?>" class="dropdown-item py-3">
                    <div class="d-flex align-items-center">
            ...
            <li>
                <a href="<?php echo e(route('admin.profile.edit', $user->id)); ?>" class="dropdown-item py-3">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 bg-light rounded-circle d-flex align-items-center justify-content-center me-3"
                             style="width: 36px; height: 36px;">
            ...
            <li>
                <a href="<?php echo e(route('profile.edit')); ?>" class="dropdown-item py-3">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 bg-light rounded-circle d-flex align-items-center justify-content-center me-3"
                             style="width: 36px; height: 36px;">
            ...
            <li>
                <a href="<?php echo e(route('admin.tableaudebord')); ?>" class="dropdown-item py-3">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 bg-light rounded-circle d-flex align-items-center justify-content-center me-3"
                             style="width: 36px; height: 36px;">
            ...
            <li class="px-3 py-2">
                <div class="row g-2">
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline-primary w-100 btn-sm">
                            <i class="bi bi-people me-1"></i> Utilisateurs
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('admin.settings')); ?>" class="btn btn-outline-warning w-100 btn-sm">
            ...
            <li class="dropdown-footer bg-light p-3 rounded-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">
                        ...
                        Dernière connexion : <?php echo e($user->last_login_at ? \Carbon\Carbon::parse($user->last_login_at)->diffForHumans() : 'Jamais'); ?>
    ...
    $('.dropdown').on('hide.bs.dropdown', function() {
        ...
        <aside class="app-sidebar bg-white shadow">
            ...
            <div class="sidebar-brand p-3 border-bottom">
                <a href="<?php echo e(route('admin.tableaudebord')); ?>" class="d-flex align-items-center text-decoration-none">
                    <img src="<?php echo e(asset('assets/img/benin logo.png')); ?>" alt="Logo" class="brand-image me-2" style="width: 40px; height: 40px; object-fit: contain;">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-3">
                    <ul class="nav flex-column">
                        ...
                        <!-- Tableau de bord -->
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.tableaudebord')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.tableaudebord') ? 'active' : ''); ?>">
                        ...
                        <!-- Administrateur -->
                        <?php if(Auth::user()->role->nom_role === 'Administrateur'): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                                    <i class="bi bi-people-fill me-2"></i> Utilisateurs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.roles.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(in_array(Auth::user()->role->nom_role, ['Administrateur', 'Contributeur'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.regions.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.regions.*') ? 'active' : ''); ?>">
                                    <i class="bi bi-globe-americas me-2"></i> Régions
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.langues.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.langues.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(in_array(Auth::user()->role->nom_role, ['Administrateur', 'Modérateur'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contenus.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.contenus.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(in_array(Auth::user()->role->nom_role, ['Administrateur', 'Contributeur'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.medias.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.medias.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(in_array(Auth::user()->role->nom_role, ['Administrateur', 'Modérateur'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.commentaires.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.commentaires.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(in_array(Auth::user()->role->nom_role, ['Administrateur', 'Contributeur'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.parler.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.parler.*') ? 'active' : ''); ?>">
                                    <i class="bi bi-link-45deg me-2"></i> Langue / Région
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.typecontenus.index')); ?>" class="nav-link sidebar-link <?php echo e(request()->routeIs('admin.typecontenus.*') ? 'active' : ''); ?>">
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"><?php echo $__env->yieldContent('page-title', 'Tableau de bord'); ?></h1>
                        </div>
        ...
        <footer class="app-footer">
            ...
            <strong>Copyright &copy; 2024 <a href="<?php echo e(url('/')); ?>" class="text-decoration-none">Culture Bénin</a>.</strong>
...
<?php /**PATH C:\wamp64\www\culture\resources\views/layouts/layout.blade.php ENDPATH**/ ?>