<?php $__env->startSection('title', 'Contribuer - Bénin Culture'); ?>
        ...
        <div class="col-12 col-xl-10">
            ...
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="<?php echo e(route('dashboard.contribuer.store')); ?>" enctype="multipart/form-data" id="contributionForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control form-control-lg <?php $__errorArgs = ['titre'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['id_type_contenu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            required>
                                        <option value="" disabled <?php echo e(old('id_type_contenu') ? '' : 'selected'); ?>>
                                        ...
                                        <?php $__currentLoopData = $typesContenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id_type_contenu); ?>"
                                                <?php echo e(old('id_type_contenu') == $type->id_type_contenu ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['id_region'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            name="id_region"
                                            required>
                                        <option value="" disabled <?php echo e(old('id_region') ? '' : 'selected'); ?>>
                                            Sélectionnez une région
                                        </option>
                                        <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($region->id_region); ?>"
                                                <?php echo e(old('id_region') == $region->id_region ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                            id="id_langue"
                                            name="id_langue">
                                        <option value="" <?php echo e(old('id_langue') ? '' : 'selected'); ?>>
                                            Français (par défaut)
                                        </option>
                                        <?php $__currentLoopData = $langues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($langue->id_langue); ?>"
                                                <?php echo e(old('id_langue') == $langue->id_langue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?php $__errorArgs = ['texte'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                              ...
                                              required><?php echo e(old('texte')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                            <a href="<?php echo e(route('dashboard.index')); ?>" class="btn btn-outline-secondary px-4 py-2">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\dashboard\contribuer.blade.php ENDPATH**/ ?>