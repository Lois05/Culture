<?php $__env->startSection('title', 'Explorer - Bénin Culture'); ?>
    ...
    <style>
        ...
        .explorer-hero {
            ...
            background: linear-gradient(rgba(26, 26, 26, 0.9), rgba(26, 26, 26, 0.9)),
                        url('<?php echo e(asset("adminlte/img/fresque.jpg")); ?>') center/cover;
        }
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="search-container">
                    <form action="<?php echo e(route('front.explorer')); ?>" method="GET" class="search-wrapper d-flex align-items-center">
                        <input type="text"
                               name="q"
    ...
    <section class="stats-section">
        <div class="container">
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e(number_format($totalContents, 0, ',', ' ')); ?></div>
                    <div class="stat-label">Contenus</div>
                </div>

                <div class="stat-card">
                    <div class="stat-number"><?php echo e(count($regions)); ?></div>
                    <div class="stat-label">Régions</div>
                </div>

                <div class="stat-card">
                    <div class="stat-number"><?php echo e(number_format($totalContributors, 0, ',', ' ')); ?></div>
                    <div class="stat-label">Contributeurs</div>
                </div>

                <div class="stat-card">
                    <div class="stat-number"><?php echo e(count($typesContenus)); ?></div>
    ...
    <section class="filters-section">
        <div class="container">
            <div class="filter-scroll">
                <button class="filter-tab <?php echo e(!request('type') ? 'active' : ''); ?>"
                        onclick="updateFilter('type', '')">
                    <i class="fas fa-th-large"></i>
                    Tous les types
                    <?php if(!request('type')): ?>
                        <span class="filter-badge"><?php echo e($totalContents); ?></span>
                    <?php endif; ?>
                </button>

                <?php $__currentLoopData = $typesContenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="filter-tab <?php echo e(request('type') == $type->id_type_contenu ? 'active' : ''); ?>"
                            onclick="updateFilter('type', '<?php echo e($type->id_type_contenu); ?>')">
                        <i class="fas <?php echo e($type->icone ?? 'fa-star'); ?>"></i>
                        <?php echo e($type->nom_contenu); ?>

                        <?php if(request('type') == $type->id_type_contenu): ?>
                            <span class="filter-badge"><?php echo e($typeCounts[$type->id_type_contenu] ?? 0); ?></span>
                        <?php endif; ?>
                    </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <button class="filter-tab <?php echo e(!request('region') ? 'active' : ''); ?>"
                ...
                <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="filter-tab <?php echo e(request('region') == $region->id_region ? 'active' : ''); ?>"
                            onclick="updateFilter('region', '<?php echo e($region->id_region); ?>')">
        ...
        <p><?php echo e($dateFormatted); ?></p>
                                ...
                                <h3 class="pin-title">
                                   <a href="<?php echo e(route('front.contenu', $contenu->id_contenu)); ?>"></a>
                                        <?php echo e(\Illuminate\Support\Str::limit($titre, 70)); ?>

                                    </a>
                                </h3>

                                <p class="pin-description">
                                    <?php echo e(\Illuminate\Support\Str::limit($description, 150)); ?>
                                ...
                                <div class="card-tags mb-3">
                                    <span class="tag">
                                        <i class="fas fa-map-marker-alt me-1"></i><?php echo e($regionNom); ?>

                                    </span>
                                    <span class="tag">
                                        <i class="fas fa-language me-1"></i><?php echo e($langueNom); ?>
                                ...
                                <div class="pin-stats">
                                    <div class="pin-stat" title="Vues">
                                        ...
                                        <span class="pin-stat-count"><?php echo e(number_format($vuesCount)); ?></span>
                                    </div>
                                    ...
                                    <div class="pin-stat" title="Commentaires">
                                        ...
                                        <span class="pin-stat-count"><?php echo e($commentsCount); ?></span>
                                    </div>
                                </div>

                                <!-- Bouton Lire -->
                            <a href="<?php echo e(route('front.contenu', $contenu->id_contenu)); ?>" class="pin-read-btn mt-3">
                ...
                <?php if($contenus->hasPages()): ?>
                    <div class="pagination-section">
                        <div class="pagination">
                            ...
                            <?php if($contenus->onFirstPage()): ?>
                                <span class="page-link disabled">
                                    <i class="fas fa-chevron-left"></i>
                                </span>
                            <?php else: ?>
                                <a href="<?php echo e($contenus->previousPageUrl()); ?>" class="page-link">
                                    <i class="fas fa-chevron-left"></i>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if($start > 1): ?>
                                <a href="<?php echo e($contenus->url(1)); ?>" class="page-link">1</a>
                                <?php if($start > 2): ?>
                            ...
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                <a href="<?php echo e($contenus->url($i)); ?>"
                                   class="page-link <?php echo e($contenus->currentPage() == $i ? 'active' : ''); ?>">
                                    <?php echo e($i); ?>

                                </a>
                            <?php endfor; ?>

                            <?php if($end < $contenus->lastPage()): ?>
                                <?php if($end < $contenus->lastPage() - 1): ?>
                                    <span class="page-link disabled">...</span>
                                <?php endif; ?>
                                <a href="<?php echo e($contenus->url($contenus->lastPage())); ?>" class="page-link">
                                    <?php echo e($contenus->lastPage()); ?>

                                </a>
                            <?php endif; ?>

                            
                            <?php if($contenus->hasMorePages()): ?>
                                <a href="<?php echo e($contenus->nextPageUrl()); ?>" class="page-link">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-4">
                        <?php if(request()->anyFilled(['q', 'type', 'region', 'langue', 'sort'])): ?>
                    ...
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="<?php echo e(route('front.explorer')); ?>" class="btn btn-primary">
                            <i class="fas fa-redo me-2"></i>Tout afficher
                        </a>
                        <a href="<?php echo e(route('dashboard.contribuer')); ?>" class="btn btn-outline-primary">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end">
                    <a href="<?php echo e(route('dashboard.contribuer')); ?>" class="btn btn-light btn-lg px-4">
...
<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\explorer.blade.php ENDPATH**/ ?>