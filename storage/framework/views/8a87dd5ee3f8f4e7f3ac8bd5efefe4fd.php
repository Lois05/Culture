...
<main class="app-main bg-light min-vh-100">
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-gradient btn-lg shadow">
                        ...
                        <tr>
                                ...
                                <?php if($user->photo && ($photoExists ?? false)): ?>
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="user-avatar-fallback rounded-circle border d-none"
                                            ...
                                            <span class="text-white fw-bold"><?php echo e($initial); ?></span>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    <strong class="mb-1"><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></strong>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\users\index.blade.php ENDPATH**/ ?>