...
<main class="app-main bg-light min-vh-100">
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('admin.roles.create')); ?>" class="btn btn-gradient btn-lg shadow">
            ...
            <div class="card-body">
                <table id="rolesTable" class="table table-striped table-hover align-middle w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="badge bg-secondary"><?php echo e($role->id); ?></span></td>
                            <td><span class="badge bg-info text-dark"><?php echo e($role->nom_role); ?></span></td>
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button type="button"
                                            ...
                                            data-name="<?php echo e($role->nom_role); ?>"
                                            title="Supprimer"
                                            data-bs-toggle="tooltip">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\roles\index.blade.php ENDPATH**/ ?>