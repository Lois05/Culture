<?php $__env->startSection('page-title', 'Modération des Contenus'); ?>
...
<main class="app-main min-vh-100">
    <div class="container-fluid mt-4">
                ...
                <div class="card bg-gradient-warning text-white shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h2 class="mb-0"><?php echo e($contenusEnAttente->total()); ?></h2>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="card bg-gradient-info text-white shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h2 class="mb-0"><?php echo e($totalContenusValides ?? 0); ?></h2>
                                <small>Validés</small>
                            </div>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="card bg-gradient-danger text-white shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h2 class="mb-0"><?php echo e($totalContenusRejetes ?? 0); ?></h2>
                                <small>Rejetés</small>
                            </div>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="card bg-gradient-success text-white shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h2 class="mb-0"><?php echo e($totalContenusTotal ?? 0); ?></h2>
                                <small>Total</small>
                            </div>
        ...
        <div class="card shadow-lg border-0 rounded-3">
            ...
            <div class="card-body">
                <?php if($contenusEnAttente->isEmpty()): ?>
                    <div class="text-center py-5">
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-success">
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $contenusEnAttente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <?php if($contenu->typeContenu): ?>
                                            <span class="badge bg-info">
                                                <i class="fas <?php echo e($contenu->typeContenu->icon ?? 'fa-file'); ?> me-1"></i>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <strong class="mb-1"><?php echo e(Str::limit($contenu->titre, 60)); ?></strong>
                                            <small class="text-muted">
                                                <?php echo e(Str::limit(strip_tags($contenu->texte), 100)); ?>

                                            </small>
                                            <div class="mt-1">
                                                <?php if($contenu->tags && $contenu->tags->isNotEmpty()): ?>
                                                    <?php $__currentLoopData = $contenu->tags->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="badge bg-light text-dark border me-1">
                                                            #<?php echo e($tag->nom_tag); ?>

                                                        </span>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($contenu->tags->count() > 2): ?>
                                                        <span class="text-muted small">+<?php echo e($contenu->tags->count() - 2); ?></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm me-2">
                                                <div class="avatar-initials bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                                                    ...
                                                    <?php if($contenu->auteur): ?>
                                                        <?php echo e(strtoupper(substr($contenu->auteur->prenom ?? 'A', 0, 1))); ?>
                                            ...
                                            <div>
                                                <?php if($contenu->auteur): ?>
                                                    <strong><?php echo e($contenu->auteur->prenom); ?> <?php echo e($contenu->auteur->name); ?></strong>
                                                    <br>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><?php echo e($contenu->date_creation->format('d/m/Y')); ?></span>
                                            <small class="text-muted">
                                                <?php echo e($contenu->date_creation->format('H:i')); ?>

                                            </small>
                                            <small class="text-info">
                                                <?php echo e($contenu->date_creation->diffForHumans()); ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <!-- Bouton Voir -->
                                            <a href="<?php echo e(route('admin.moderateur.show', $contenu->id_contenu)); ?>"
                                            ...
                                            <button type="button"
                                                    ...
                                                    data-contenu-id="<?php echo e($contenu->id_contenu); ?>"
                                                    data-contenu-titre="<?php echo e($contenu->titre); ?>"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="text-muted">
                            Affichage de <?php echo e($contenusEnAttente->firstItem() ?? 0); ?> à <?php echo e($contenusEnAttente->lastItem() ?? 0); ?>

                            sur <?php echo e($contenusEnAttente->total()); ?> contenus
                        </div>
                        <div>
                            <?php echo e($contenusEnAttente->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\moderateur\index.blade.php ENDPATH**/ ?>