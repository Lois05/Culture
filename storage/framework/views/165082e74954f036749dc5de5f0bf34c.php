<?php $__env->startSection('title', 'Paiement confirmé - Bénin Culture'); ?>
            ...
            <div class="col-lg-8">
                <div class="success-card" data-aos="zoom-in">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="text-start">
                                    ...
                                    <div class="fw-bold"><?php echo e($paiement['reference'] ?? 'N/A'); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="text-start">
                                    <small class="text-muted">Date</small>
                                    <div class="fw-bold"><?php echo e($paiement['date'] ?? now()->format('d/m/Y H:i')); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="text-start">
                                    <small class="text-muted">Montant</small>
                                    <div class="fw-bold"><?php echo e($paiement['montant'] ?? 'N/A'); ?></div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="text-start">
                                    ...
                                    <div class="fw-bold text-success">
                                        ...
                                        <?php echo e($paiement['statut'] ?? 'Payé'); ?>
                    ...
                    <div class="alert alert-success" role="alert">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">"<?php echo e($contenu->titre); ?>" est maintenant accessible</p>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-grid gap-3 d-md-flex justify-content-center">
                        <a href="<?php echo e(route('dashboard.index')); ?>" class="btn btn-primary btn-lg px-5">
                            <i class="bi bi-speedometer2 me-2"></i>
                            Aller au tableau de bord
                        </a>

                        <a href="<?php echo e(route('front.explorer')); ?>" class="btn btn-outline-dark btn-lg px-5">
...
<?php echo $__env->make('layouts.layout_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\culture\resources\views\front\boutique\success.blade.php ENDPATH**/ ?>